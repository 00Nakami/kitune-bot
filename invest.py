...
DEFAULT_MARKET = {
    "のば鉄道": {"price_per_share": 10000, "up_rate": 0.15, "down_rate": 0.15, "min_price": 10000},
    "くるあパティスリー": {"price_per_share": 2000, "up_rate": 0.07, "down_rate": 0.07, "min_price": 2000},
    "きつね製麺": {"price_per_share": 200, "up_rate": 0.02, "down_rate": 0.02, "min_price": 200},
    "なえくん水族館": {"price_per_share": 400, "up_rate": 0.03, "down_rate": 0.03, "min_price": 400},
    "しし動物園": {"price_per_share": 600, "up_rate": 0.04, "down_rate": 0.04, "min_price": 600},
    "はむっちペットショップ": {"price_per_share": 800, "up_rate": 0.05, "down_rate": 0.05, "min_price": 800},
    "くろねこ画廊": {"price_per_share": 6000, "up_rate": 0.11, "down_rate": 0.11, "min_price": 6000},
    "やまとん銃工": {"price_per_share": 8000, "up_rate": 0.13, "down_rate": 0.13, "min_price": 8000},
    "あゆかは精肉店": {"price_per_share": 1000, "up_rate": 0.06, "down_rate": 0.06, "min_price": 1000},
    "ぴー貴族": {"price_per_share": 4000, "up_rate": 0.09, "down_rate": 0.09, "min_price": 4000},
    "じゅんちゃん喫茶": {"price_per_share": 7000, "up_rate": 0.12, "down_rate": 0.12, "min_price": 7000},
    "ふみ家具店": {"price_per_share": 3000, "up_rate": 0.08, "down_rate": 0.08, "min_price": 3000},
    "あいす・雪だるま店": {"price_per_share": 9000, "up_rate": 0.14, "down_rate": 0.14, "min_price": 9000},
    "猫カフェねこねこ": {"price_per_share": 5000, "up_rate": 0.1, "down_rate": 0.1, "min_price": 5000},
    "なかみぃ神社": {"price_per_share": 100, "up_rate": 0.01, "down_rate": 0.01, "min_price": 100},
}
...
class Invest(commands.Cog):
    ...
    async def market(self, interaction: discord.Interaction):
        ...
        for name, info in self.market.items():
            price = info.get("price_per_share", "?")
            up = info.get("up_rate", 0)
            down = info.get("down_rate", 0)
            embed.add_field(
                name=name,
                value=f"{price} にゃんにゃん/株\n📈上昇: +{int(up*100)}% 📉下降: -{int(down*100)}%",
                inline=False
            )
